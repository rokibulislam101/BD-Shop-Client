...
//     navigate(`/Product/${productId}`); // Ensure this path matches router
//   };
...
//                       <AiOutlineHeart className="text-3xl text-[#fc6221] hover:text-white rounded-full hover:bg-[#fc6221] hover:p-1 transition-all" />
//                     </div>
//                     <div
...
//               </div>
//               <button
//                 onClick={() => handleBuyNow(product._id)} // Attach click handler
